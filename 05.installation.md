...
我们在本书中提及“Python 3”时，我们指的是任何大于等于 [ ](https://www.python.org/downloads/) 的 Python 发行版。

## 在 Windows 中安装

访问 [https://www.python.org/downloads/](https://www.python.org/downloads/) 并下载最新版本的 Python。在本书撰写的时点，最新版本为 Python 3.5.1。 其安装过程与其它 Windows 平台的软件的安装过程无异。
